...
1. **Review the document** - Add comments and suggest changes as usual <!-- review-comment -->
2. **Connect to GitHub** - Click the "Connect to Git" button in the toolbar
3. **Authenticate** - Follow the device flow instructions to authenticate <!-- review-comment -->
...
- Creates branches and PRs automatically <!-- review-comment -->
